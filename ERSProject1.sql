...
INSERT INTO ERS_REIMBURSEMENT VALUES (0, 120, 'Food', null, null, null, 23, 26, 2, 1);
...
INSERT INTO ERS_USERS VALUES (1, 'pvalenzuela', 'papa', 'Peter', 'Valenzuela', 'papajuans@pizza.com', 1);

INSERT INTO ERS_USER_ROLE VALUES (1, 'Food');
...
SELECT * FROM ERS_REIMBURSEMENT WHERE REIMB_ID = 0;
INSERT INTO ERS_REIMBURSEMENT VALUES (2, ?, ?, ?, ?, null, 1, ?)